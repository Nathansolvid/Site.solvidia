      ...
      >
        <div className="relative">
          <motion.div
            style={{
              display: 'flex',
              // On évite `overflow: hidden` ici : il clippait les descendants
              // (j, g, y, p, q). Les lettres ont `opacity: 0` en initial donc
              // elles restent invisibles pendant qu'elles montent vers y:0.
            }}
            variants={container}
            initial="hidden"
